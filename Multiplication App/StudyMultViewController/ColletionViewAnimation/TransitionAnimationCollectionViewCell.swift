//
//  TransitionAnimationCollectionViewCell.swift
//  Multiplication App
//
...
class TransitionAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        let containerView = transitionContext.containerView
         ...
         if !presenting {
            UIView.animate(withDuration: durationExpanding, delay:3,
            usingSpringWithDamping: 1.0, initialSpringVelocity: 0.0,
            animations: {
                containerView.transform = CGAffineTransform(scaleX: -3, y: -3)
